      ...
      <div className="container grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold leading-tight text-secondary">
            Освой <span className="text-primary">продвинутую разработку</span> за 8 недель
          </h1>
          <p className="text-lg text-secondary/80 md:text-xl max-w-lg">
            Самый эффективный курс по программированию с реальными проектами и менторством от опытных разработчиков
          </p>
          
          <div className="flex flex-wrap gap-4 pt-2">
            <Button size="lg" className="group">
              Начать обучение
              <Icon name="ArrowRight" className="ml-1 transition-transform group-hover:translate-x-1" />
            </Button>
          ...
          <div className="flex items-center gap-4 pt-4">
            ...
            <div className="text-sm text-secondary/70">
              <span className="text-secondary font-semibold">2.5k+</span> учеников уже с нами
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="p-6 pb-8">
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm font-medium text-primary-700 bg-primary-50 px-3 py-1 rounded-full">Профессия</span>
                <div className="flex items-center text-yellow-500">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Icon key={star} name="Star" className="w-4 h-4 fill-current" />
                  ))}
                  <span className="ml-1 text-xs font-medium text-secondary">4.9</span>
                </div>
              </div>
              <h3 className="text-xl font-bold font-heading mb-2">Полный курс по программированию</h3>
              <p className="text-secondary/70 text-sm mb-4">Освойте навыки, которые сделают вас востребованным разработчиком на рынке труда</p>
